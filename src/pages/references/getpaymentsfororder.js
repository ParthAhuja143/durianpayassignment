...
import { faAlignJustify, faArrowLeft, faArrowRight, faBars, faBookOpen, faCaretRight, faCross,faTimes, faHamburger, faHome, faStopwatch } from "@fortawesome/free-solid-svg-icons"
import { useState, useEffect } from 'react';
import GET from '../../components/get';
import POST from '../../components/post';
import axios from 'axios';

const ReferencesGetPaymentForOrdersPage = () => {
    ...
    return(
    <Layout>
        <Seo title = 'Get Payments for Order'/>
            ...
            <div className = 'api-main-body'>
                <div className = {`sidebar ${menuOpen ? 'transRight' : 'transLeft'}`}>
                    ...
                    <div className = 'sidebar-section'>
                        ...
                        {paymentsOpen && <ul className = 'sidebar-option-1-dropdown'>
                            <li className = 'active'><span className = 'list-title'>Get Payments for Orders</span><GET/></li>
                ...
                <div className = 'api-content'>
                    ...
                    <div className = 'api-subheading'>
                        <GET/> <span style = {{paddingLeft: '5px'}}>https://sandbox.cashfree.com/pg/orders/{`${`{order_id}`}`}/payments</span>
                    </div>
                    ...
                    <div className = 'api-footer'>
                        ...
                        <div className = 'api-footer-next-prev'>
                            ...
                            <span className = 'api-footer-prev'>
                                <FontAwesomeIcon icon = {faArrowLeft} /> Get Order
                            </span>
                            </Link>
                            <Link to = '/references/getpaymentbyid'>
                            <span className = 'api-footer-next'>
                                Get Payment by ID <FontAwesomeIcon icon = {faArrowRight} />
                            </span>
                            </Link>
                        </div>
                    </div>
                ...
                <div className = 'api-code'>
                    ...
                    <div className="codeSnippet">
                        ...
                        {activeScreenIndex === 0 && <div className = 'codeBody'>
                            ...
                            <div className = 'codeLine p-10'><span className = 'purpleCodeLine'>--url</span> https://sandbox.cashfree.com/pg/orders/{`${order_id !== '' ? order_id : 'order_id'}`}/payments <span className = 'whiteCodeLine'>\</span></div>
                        ...
                        </div>}
                        {
                            activeScreenIndex === 1 && <div className = 'codeBody'>
                                ...
                                <div className = 'codeLine'><span className = 'redCodeLine'>sdk</span><span className = 'whiteCodeLine'>.</span><span className = 'purpleCodeLine'>GetPaymentForOrders</span><span className = 'whiteCodeLine'>({`${`{`}`}</span></div>
                                <div className = 'codeLine'></div>
                        ...
                        }
                        {
                            activeScreenIndex === 2 && <div className = 'codeBody'>
                                ...
                                <div className = 'codeLine'></div>
                                <div className = 'codeLine'><span className = 'redCodeLine'>url</span><span className = 'blueCodeLine'> = </span> <span className = 'redCodeLine'> URI</span><span className = 'whiteCodeLine'>(</span>"https://sandbox.cashfree.com/pg/orders/{`${order_id !== '' ? order_id : 'order_id'}`}/payments"<span className = 'whiteCodeLine'>)</span></div>
                        ...
                        }
                        {
                            activeScreenIndex === 4 && <div className="codeBody">
                                ...
                                <div className="codeLine"></div>
                                <div className="codeLine"><span className="redCodeLine">url</span><span className="blueCodeLine"> = </span>"https://sandbox.cashfree.com/pg/orders/{`${order_id !== '' ? order_id : 'order_id'}`}/payments"</div>
...
export default ReferencesGetPaymentForOrdersPage;